...
class App {
    ...
    private static List<DownloadTaskPanel> downloadPanels = new ArrayList<>();
    ...
    private static class DownloadTaskPanel extends JPanel {
        ...
        private void initUI() {
            ...
            add(new JLabel("任务：" + title));
            add(taskProgressBar);
        }

        public Runnable getDownloadTask() {
            return new DownloadTask(videoUrl, downloadDirectory, title, nThread, taskProgressBar);
        }
        ...
        private class DownloadTask implements Runnable {
            ...
            public DownloadTask(String videoUrl, String downloadDirectory, String title, int nThread, JProgressBar taskProgressBar) {
                this.videoUrl = videoUrl;
                this.downloadDirectory = downloadDirectory;
                this.title = title;
                this.nThread = nThread;
